# DevSpace
DevSpace is a fully-featured social media web application, built with the MERN stack.  

Deployed at: https://post-it-heroku.herokuapp.com/  
![GIF of DevSpace walkthrough](https://media.giphy.com/media/9tnaXy42T4NzSJdHhP/giphy.gif)
