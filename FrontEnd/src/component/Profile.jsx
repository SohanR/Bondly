...
import { getFeedUser } from "../api/posts/postApi";
import { followUser, unfollowUser } from "../api/users/userApi";
...
const Profile = () => {
  ...
  const clickfollow = () => {
    let callApi = value.following == false ? followUser : unfollowUser;
